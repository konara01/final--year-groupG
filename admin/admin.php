...
<table>
  ...
  <tbody>
    ...
    foreach  ($lecturers as $staff) {
      ...
      echo "<td>";
      echo "<a href='lecturers/editlecturer.php?lecturer_id=" . $staff->lecturer_id . "' class='edit-button'>Edit</a> ";
      echo "<a href='lecturers/deletelecturer.php?lecturer_id=" . $staff->lecturer_id . "' onclick='return confirm(\"Are you sure you want to delete this user?\")' class='delete-button'>Delete</a>";
      echo "</td>";
      echo "</tr>";
    }
    ?>
  ...
  <?php
    ...
    foreach  ($students as $student) {
      ...
      echo "<td>";
      echo "<a href='students/edituser.php?student_id=" . $student->student_id . "' class='edit-button'>Edit</a> ";
      echo "<a href='students/deleteuser.php?student_id=" . $student->student_id . "' onclick='return confirm(\"Are you sure you want to delete this students?\")' class='delete-button'>Delete</a>";
      echo "</td>";
      echo "</tr>";
    }
    ?>
