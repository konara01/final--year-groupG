...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // If no errors, update the $student in the database
    if (empty($errors)) {
        $student = array(
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
        ...
        <table class="styled-table">
            <tr>
                ...
                <td><input type="text" name="student_name" value="<?php echo htmlspecialchars($student->student_name); ?>"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input class="btn" type="submit"  value="Update Student" required></td>
            </tr>
        </table>
    </form>
</div>
