...
<form class="conteiner" method="post" action="" enctype="multipart/form-data">
...
<input type="text" name="student_name" size="40" class="name" aria-required="true" aria-invalid="false" placeholder="Name*">
