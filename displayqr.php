...

{
    ...
    $qrid = filter_var($_GET['qrid'], FILTER_SANITIZE_NUMBER_INT);
    $qrcode = get_qrcode_by_id($qrid);
    if (!$qrcode) {
   ...
   <div class="table-responsive">  
    ...
    <div class="qrcode-card">
        <div class="qrcode-image">
            <img src="<?php echo $qrcode->image_name; ?>" width="500" height="600" alt="Qr code for todays attendance">
        </div>
        <div class="Qrcode-details">
            <h3><?php echo $qrcode->lesson_name; ?></h3>
            <p><strong>Time You are Required to be:</strong> <?php echo $qrcode->time; ?></p>
